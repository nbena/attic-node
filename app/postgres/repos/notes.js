...
Repository.SELECT_NOTES_BY_TAGS_START = 'select json_array(\'{title, text, isDone, creationDate, lastModificationDate, links}\', array[title, text, isDone:: text, creationDate::text, lastModificationDate::text, links::text]) from attic.notes join attic.notes_tags as rel on title=noteTitle where rel.userid=\'';
