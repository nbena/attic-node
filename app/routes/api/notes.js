...
router.post('/by-tags-no-role', auth, note_endpoint_1.default.selectNotesByTagsNoRole);
router.post('/by-tags-with-role', auth, note_endpoint_1.default.selectNotesByTagsWithRole);
